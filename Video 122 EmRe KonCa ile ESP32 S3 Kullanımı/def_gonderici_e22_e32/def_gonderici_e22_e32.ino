...
void setup() {
  ...
  switch (selectedOption) {
    ...
    case nano:
      ...
      break;
    default:
      Serial.println("Henüz Geliştirmediğimiz bir PCB Seçildi");
      break;
  }
}
...
void loop() {
  ...
  *(int*)(data.btn3) = id;
  ...
  ResponseStatus rs = FixajSerial.sendFixedMessage(highByte(GonderilecekAdres), lowByte(GonderilecekAdres), Kanal, &data, sizeof(Signal));
